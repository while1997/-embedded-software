...
extern __IO u8 readflag;
extern u8 send_wave_flag;
extern u8 recv_buf[20];
void send_data(u8 *buff,u8 len);
/*----------------------------------------------------------------------------+
| Constant Definition                                                         |
+----------------------------------------------------------------------------*/
#define AFE_RDY 				HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_11)
#define PRF             100
#define DUTYCYCLE       20
#define AFECLK          4000000ul


#define	 	AFE_CLKOUT_GPIO						GPIOA
#define	 	AFE_CLKOUT_Pin						GPIO_PIN_8

#define 	AFE_RESET_GPIO						GPIOA
#define		AFE_RESET_Pin							GPIO_PIN_11

#define		AFE_ADC_RDY_GPIO					GPIOA
#define		AFE_ADC_RDY_Pin						GPIO_PIN_12

#define 	AFE_DIAG_END_GPIO					GPIOB
#define		AFE_DIAG_END_Pin					GPIO_PIN_11

#define 	AFE_PD_ALM_GPIO						GPIOB
#define		AFE_PD_ALM_Pin						GPIO_PIN_6

#define 	AFE_LED_ALM_GPIO					GPIOB
#define		AFE_LED_ALM_Pin						GPIO_PIN_7

#define 	AFE_PDN_GPIO					GPIOB
#define		AFE_PDN_Pin						GPIO_PIN_10
...
void Enable_AFE4400_SPI_Read (void);
void Disable_AFE4400_SPI_Read (void);
...
extern unsigned long AFE4400_Current_Register_Settings[36];
